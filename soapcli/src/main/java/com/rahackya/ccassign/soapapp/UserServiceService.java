 ...
 * 
 */
@WebServiceClient(name = "UserServiceService", targetNamespace = "http://soapapp.ccassign.rahackya.com/", wsdlLocation = "http://localhost:8080/soapapp/UserService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICESERVICE_QNAME = new QName("http://soapapp.ccassign.rahackya.com/", "UserServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/soapapp/UserService?wsdl");
    ...
    public UserService getUserServicePort() {
        return super.getPort(new QName("http://soapapp.ccassign.rahackya.com/", "UserServicePort"), UserService.class);
    }
    ...
    public UserService getUserServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soapapp.ccassign.rahackya.com/", "UserServicePort"), UserService.class, features);
    }
